...
declare namespace game{
    class totoyconfig extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: totoyconfig): totoyconfig;
        static _toPtr(p: number, v: totoyconfig): void;
        static _tempHeapPtr(v: totoyconfig): number;
        static _dtorFn(v: totoyconfig): void;
    }
