...
game.totoyconfig = function(arg0) {
  this._hoi = (arg0 === undefined ? new Array() : ((arg0 instanceof Array) ? arg0 : (function() { throw new Error('Assigning non-array to array field'); })()));
};
game.totoyconfig.prototype = Object.create(null);
game.totoyconfig.prototype.constructor = game.totoyconfig;
Object.defineProperties(game.totoyconfig.prototype, {
  hoi: {
    get: function() { return this._hoi; },
    set: function(v) { this._hoi = (v === undefined ? new Array() : ((v instanceof Array) ? v : (function() { throw new Error('Assigning non-array to array field'); })())); },
  },
});
game.totoyconfig._size = 12;
game.totoyconfig._fromPtr = function(ptr, v) {
  v = v || Object.create(game.totoyconfig.prototype);
  v._hoi = ut.nativeBufferToJsArray(ptr+0, 8, function(p) { return (Module._ut_nativestring_data(p) ? UTF8ToString(Module._ut_nativestring_data(p)) : ""); });
  return v;
};
game.totoyconfig._toPtr = function(ptr, v) {
  ut.jsArrayToExistingNativeBuffer_string(v.hoi, ptr+0, function(p, v) { ut.writeHeapNativeString(p, v); });
};
game.totoyconfig._toTempHeapPtr = function(ptr, v) {
  ut.jsArrayToExistingScratchNativeBuffer_string(v.hoi, ptr+0, function(p, v) { ut.toExistingScratchNativeString(p, v); });
};
game.totoyconfig._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(12);
  if (v) game.totoyconfig._toTempHeapPtr(ptr, v);
  return ptr;
};
game.totoyconfig.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.totoyconfig.StorageView.prototype = Object.create(null);
game.totoyconfig.StorageView.prototype.constructor = game.totoyconfig.StorageView;
game.totoyconfig._view = game.totoyconfig.StorageView;
game.totoyconfig.StorageView._isSharedComp = game.totoyconfig._isSharedComp = false;
game.totoyconfig.StorageView._fromPtr = game.totoyconfig._fromPtr;
game.totoyconfig.StorageView._toPtr = game.totoyconfig._toPtr;
game.totoyconfig.StorageView._tempHeapPtr = game.totoyconfig._tempHeapPtr;
game.totoyconfig.StorageView._size = game.totoyconfig._size;
game.totoyconfig.StorageView.prototype.$advance = function() {
  this._ptr += 12;
};
Object.defineProperties(game.totoyconfig.StorageView.prototype, {
  hoi: {
    get: function() { return ut.nativeBufferToJsArray(this._ptr+0, 8, function(p) { return (Module._ut_nativestring_data(p) ? UTF8ToString(Module._ut_nativestring_data(p)) : ""); }); },
    set: function(v) { ut.jsArrayToExistingNativeBuffer_string(v, this._ptr+0, function(p, v) { ut.writeHeapNativeString(p, v); }); },
  },
});
game.totoyconfig._dtorFn = function dtor(ptr) {
  if (!ptr) return; 
  Module._ut_nativebuffer_nativestring_placement_delete(ptr + 0);
};
game.totoyconfig._copyFn = function copy(src, dst) {
  if (!src) throw 'copy function src ptr is null!';
  if (!dst) throw 'copy function dst ptr is null!';
  Module._ut_nativebuffer_nativestring_copy_construct(dst + 0, src + 0);
};
game.totoyconfig._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.totoyconfig', 12, [
    {name: 'hoi', offset: 0, type: ut.meta.getType('ut.NativeBuffer<string>')}
  ]);
})();
Object.defineProperties(game.totoyconfig, { cid: { configurable: true, get: function() { delete game.totoyconfig.cid; var offsetsPtr = 0, offsetsCount = 0; return game.totoyconfig.cid = Module._ut_component_register_cid_with_type(game.totoyconfig._typeDesc, 4, 0, offsetsPtr, offsetsCount, ut.DestructorFn._cb.token_for(game.totoyconfig._dtorFn), ut.CopyFn._cb.token_for(game.totoyconfig._copyFn)); } } });
Object.defineProperties(game.totoyconfig.StorageView, { cid: { configurable: true, get: function() { return game.totoyconfig.cid; } } });
game.totoyconfig.hoi = { $ofs:0, $t:"ut.DynamicArray`1", $c:game.totoyconfig };
var ut = ut || {};
ut.Core2D = ut.Core2D || {};
